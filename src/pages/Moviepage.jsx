...
const Moviepage = () => {
  ...
  const options = {
    ...
    headers: {
      ...
      Authorization:
        "Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiJmZmY5MGUzODQwZThiYThkYzRkYTUzZWZlMTE0NzlkZSIsIm5iZiI6MTc2OTk0MDUyOC4wMDQsInN1YiI6IjY5N2YyNjJmMTcyOGY5ZTg5MWQ0NDYzOSIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.oYZdjSwXbj-jkdGt6M3EwyAe8lqeWVm-_CeCoNk5AJE",
    },
  };
  useEffect(() => {
